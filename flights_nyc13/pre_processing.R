...
##weather features
#pressure
pressure_df<-flights_full%>% group_by(pressure)%>% summarise(total_counts=n(), mean_delay=mean(dep_delay))
pressure_df$normalized_dep<-pressure_df$mean_delay/pressure_df$total_counts
